...
以下のコマンドで PHP のバージョンが表示されることを確認します。
...
phpMyAdmin の確認: http://localhost:8081/

サーバーアクセス: http://localhost:8000 

node サーバーアクセス: http://localhost:5173/
